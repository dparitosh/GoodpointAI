...
def test_opensearch_config_is_encrypted_and_password_preserved(tmp_path, monkeypatch) -> None:
    ...
    db_path = tmp_path / "test_opensearch_config.db"
    ...
    # Register ORM models
    from models.configuration_models import EncryptedConfig  # noqa: F401
