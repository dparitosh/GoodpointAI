...
# WARNING: This query fetches all nodes and relationships. For large graphs,
# consider adding a LIMIT clause (e.g., "MATCH (n) OPTIONAL MATCH (n)-[r]-(m) RETURN n, r, m LIMIT 100")
# or implementing pagination for production environments to prevent performance issues.
