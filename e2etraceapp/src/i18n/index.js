  ...
  en: {
    translation: {
      nav: {
        ...
        step1Connect: '1. Connect',
        step2Discovery: '2. Discovery',
        step3Map: '3. Map',
        ...
        batchProcessor: 'Batch File Processor',
        ruleEngine: 'Rule Engine',
        dataOperations: 'Data Operations',
        dataConfig: 'Data Sources',
        dataMapping: 'Data Mapping',

        spreadsheet: 'Spreadsheet',
        dataProcessingHub: 'Processing Hub',
  ...
  es: {
    translation: {
      nav: {
        ...
        overview: 'Resumen',
        search: 'Búsqueda',
        conversationalSearch: 'Búsqueda Conversacional',
        ...
        batchProcessor: 'Procesador de archivos en lote',
  ...
  fr: {
    translation: {
      nav: {
        ...
        batchProcessor: 'Traitement par lots de fichiers',
  ...
  de: {
    translation: {
      nav: {
        ...
        batchProcessor: 'Stapeldateiverarbeitung',
