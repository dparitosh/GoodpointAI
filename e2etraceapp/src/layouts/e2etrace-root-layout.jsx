...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    href: '/migration',
    matchPrefixes: ['/migration', '/workflows', '/workflow'],
    items: [
  ...
  },
  {
    ...
    href: '/data-discovery',
    matchPrefixes: ['/data-discovery', '/dq-dashboard', '/lineage'],
    items: [
      { to: '/data-discovery', labelKey: 'nav.dataDiscovery',  icon: 'fas fa-compass' },
  ...
  },
  {
    ...
    href: '/analytics',
    matchPrefixes: ['/self-healing', '/observability', '/analytics', '/reporting-hub'],
    items: [
